...
bool GlobalPlannerNode::LoadConfig(std::string file){
    ...
    std::string config_path = "/home/lovezy/catkin_car/src/service_node/config/planning_config.yaml";
...
bool GlobalPlannerNode::CalPath(robot_msgs::Planning::Request  &req,
    ...
    ROS_INFO("get goal! /n the pose is [%f,%f],the goal is [%f,%f]",my_pose.x,my_pose.y,goal.x,goal.y);
