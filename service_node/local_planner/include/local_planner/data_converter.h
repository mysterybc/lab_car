...
class DataConverter {
 public:
  /**
   * @brief Convert costmap_node::RobotPose to std::pair<Eigen::Vector2d, double>
   * @param pose Data structure of costmap_node::RobotPose
   * @return Data structure of std::pair<Eigen::Vector2d, double>
   */
  static std::pair<Eigen::Vector2d, double> LocalConvertRMData(const costmap_node::RobotPose &pose) {
