...
class LocalPlannerNode {
 ...
 private:
  ...
  actionlib::SimpleActionServer<robot_msgs::LocalPlannerAction> as_;
  ...
  //! error info
  ErrorInfo node_error_info_;
  //! local cost map
  std::shared_ptr<costmap_node::CostmapInterface> local_cost_;
  //! tf pointer
  ...
  robot_msgs::TwistAccel cmd_vel_;
  //! visualization ptr
