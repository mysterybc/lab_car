...
int main(int argc,char **argv){
    ...
    path_coverage.request.select_point.poses.push_back(set_pose(6.1,10.1));
    path_coverage.request.select_point.poses.push_back(set_pose(10.1,6.1));
    path_coverage.request.select_point.poses.push_back(set_pose(10,10));
