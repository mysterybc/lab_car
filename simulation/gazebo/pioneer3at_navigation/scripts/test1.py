...
class NavTest():  
    def __init__(self):  
        ...
        self.path_pub=rospy.Publisher('robot1_path', Path, queue_size=10)
        ...
        self.locations['p2'] = Pose(Point(-3.000, 2.000, 0.000), Quaternion(0.000, 0.000, -0.707, 0.707))  
        self.locations['p4'] = Pose(Point(-5.000,6.000, 0.000), Quaternion(0.000, 0.000, 0.000, 1.000))  
        self.locations['p1'] = Pose(Point(-7.000, 2.000, 0.000), Quaternion(0.000, 0.000, 0.707, 0.707))  
        self.locations['p3'] = Pose(Point(-5.000, -2.000, 0.000), Quaternion(0.000, 0.000, 1.000, 0.000))  
    ...
    def open_door(self):
        goal_pose=Pose(Point(-8.000, 8.000, 0.000), Quaternion(0.000, 0.000, -0.707, 0.707))  
    ...
    def get_pos(self): 
        try: 
            (trans, rot) = self.tf_listener.lookupTransform('/map', '/robot1/base_link', rospy.Time(0)) 
