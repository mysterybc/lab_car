...
class NavTest():  
    def __init__(self):  
        ...
        #设定前往的坐标位置
        locations['p1'] = Pose(Point(0.000, 0.500, 0.000), Quaternion(0.000, 0.000, 0.0180, -1.000))  
        locations['p2'] = Pose(Point(-3.000,-1.000, 0.000), Quaternion(0.000, 0.000, -0.7500, 0.600))  
        locations['p3'] = Pose(Point(3.000,-1.000, 0.000), Quaternion(0.000, 0.000, -0.0200, 1.000))  
